...
// We asume that only for older version of Harpocrates LIBCRYPTO_VERSION is not defined
#ifndef LIBCRYPTO_VERSION
#define LIBCRYPTO_VERSION 2
#endif
...
void sha_hash(const std::vector<uint8_t> &data, std::vector<uint8_t> &hash, const hash_type);
#else
